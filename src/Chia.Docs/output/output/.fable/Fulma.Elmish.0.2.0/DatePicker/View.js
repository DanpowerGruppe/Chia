...
import { addMonths as Date_addMonths, addDays as Date_addDays, dayOfWeek as Date_dayOfWeek, create as Date_create, year as Date_year, day as Date_day, utcNow as Date_utcNow, month as Date_month } from "../../../../.fable/fable-library.3.0.0-nagareyama-beta-002/Date.js";
import { op_UnaryNegation_Int32 as Int32_op_UnaryNegation_Int32 } from "../../../../.fable/fable-library.3.0.0-nagareyama-beta-002/Int32.js";
import { ofArray as List_ofArray, singleton as List_singleton, empty as List_empty, map as List_map, append as List_append, splitAt as List_splitAt, ofSeq as List_ofSeq } from "../../../../.fable/fable-library.3.0.0-nagareyama-beta-002/List.js";
import { empty as Seq_empty, append as Seq_append, singleton as Seq_singleton, collect as Seq_collect, delay as Seq_delay, rangeNumber as Seq_rangeNumber } from "../../../../.fable/fable-library.3.0.0-nagareyama-beta-002/Seq.js";
import { printf as String_printf, toFail as String_toFail } from "../../../../.fable/fable-library.3.0.0-nagareyama-beta-002/String.js";
