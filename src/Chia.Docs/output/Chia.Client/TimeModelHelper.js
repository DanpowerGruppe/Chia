...
import { addDays as Date_addDays, day as Date_day, month as Date_month, year as Date_year, now as Date_now, create as Date_create } from "../.fable/fable-library.3.0.0-nagareyama-beta-002/Date.js";
import { printf as String_printf, toConsole as String_toConsole } from "../.fable/fable-library.3.0.0-nagareyama-beta-002/String.js";
import { toUniversalTime as DateOffset_toUniversalTime, fromDate as DateOffset_fromDate } from "../.fable/fable-library.3.0.0-nagareyama-beta-002/DateOffset.js";
