...
import { enum_type as Reflection_enum_type, int32_type as Reflection_int32_type, record_type as Reflection_record_type, string_type as Reflection_string_type } from "../../../.fable/fable-library.3.0.0-nagareyama-beta-002/Reflection.js";
...
export function DaysOfWeek$reflection() {
    return Reflection_record_type("Date.Local.DaysOfWeek", [], DaysOfWeek, () => [["Monday", Reflection_string_type], ["Tuesday", Reflection_string_type], ["Wednesday", Reflection_string_type], ["Thursday", Reflection_string_type], ["Friday", Reflection_string_type], ["Saturday", Reflection_string_type], ["Sunday", Reflection_string_type]]);
}
...
export function Date$$reflection() {
    return Reflection_record_type("Date.Local.Date", [], Date$, () => [["Months", Months$reflection()], ["AbbreviatedMonths", Months$reflection()], ["Days", DaysOfWeek$reflection()], ["AbbreviatedDays", DaysOfWeek$reflection()], ["DefaultFormat", Reflection_string_type], ["FirstDayOfTheWeek", Reflection_enum_type("System.DayOfWeek", Reflection_int32_type, [["Sunday", 0], ["Monday", 1], ["Tuesday", 2], ["Wednesday", 3], ["Thursday", 4], ["Friday", 5], ["Saturday", 6]])]]);
}
...
export function Time$reflection() {
    return Reflection_record_type("Date.Local.Time", [], Time, () => [["AM", Reflection_string_type], ["PM", Reflection_string_type]]);
}
...
export function Localization$reflection() {
    return Reflection_record_type("Date.Local.Localization", [], Localization, () => [["Date", Date$$reflection()], ["Time", Time$reflection()]]);
}
