...
export function Promise_mapResult(fn, a) {
    const pr = a;
    return pr.then(((result) => Option_mapOk(fn, result)));
}
...
export function Promise_mapResultError(fn, a) {
    const pr = a;
    return pr.then(((result) => Option_mapError(fn, result)));
}
...
export function Promise_PromiseBuilder$reflection() {
    return Reflection_class_type("Fable.PowerPack.Promise.PromiseBuilder", void 0, Promise_PromiseBuilder);
}
...
export function Promise_PromiseBuilder__For_1565554B(x, seq, body) {
...
export function Promise_PromiseBuilder__While_2044D34(x, guard, p) {
    if (guard()) {
        return p.then((() => Promise_PromiseBuilder__While_2044D34(x, guard, p)));
    }
    else {
...
export function Promise_PromiseBuilder__TryFinally_7D49A2FD(x, p, compensation) {
    return p.then(((x_1) => {
        compensation();
        return x_1;
    }),((er) => {
...
export function Promise_PromiseBuilder__Delay_62FBFDE1(x, generator) {
...
export function Promise_PromiseBuilder__Run_212F1D4B(x, p) {
...
export function Promise_PromiseBuilder__Using_74F7E79D(x, resource, binder) {
    return Promise_PromiseBuilder__TryFinally_7D49A2FD(x, binder(resource), () => {
        let copyOfStruct = resource;
        copyOfStruct.Dispose();
    });
}

export const PromiseImpl_promise = Promise_PromiseBuilder_$ctor();
