                    ...
                    if ((Reflection_fullName(keyType) === "System.String") ? true : (Reflection_fullName(keyType) === "System.Guid")) {
                        return (value_12) => {
                            ...
                            return Seq_fold((target, _arg1) => {
                                const activePatternResult17093 = _arg1;
                                const v_1 = activePatternResult17093[1];
                                const k = activePatternResult17093[0];
                        ...
                        return (value_13) => {
                            ...
                            values_4 = Seq_map((_arg2) => {
                                const activePatternResult17097 = _arg2;
                                const v_2 = activePatternResult17097[1];
                                const k_1 = activePatternResult17097[0];
