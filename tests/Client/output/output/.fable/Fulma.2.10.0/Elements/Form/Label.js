...
export function Option$reflection() {
    return Reflection_union_type("Fulma.Label.Option", [], Option, () => [[["Item", Common_Size_ISize$reflection()]], [["Item", Reflection_string_type]], [["Item", Reflection_string_type]], [["Item", Reflection_list_type(Reflection_class_type("Fable.React.Props.IHTMLProp"))]], [["Item", Reflection_list_type(Common_Modifier_IModifier$reflection())]]]);
}
...
export function label(options, children) {
    const parseOptions = (result, option) => {
        switch (option.tag) {
            case 1: {
                ...
                const arg00_1 = new Fable$002EReact$002EProps_HTMLAttr(96, htmlFor);
    ...
    return Common_Common_GenericOptions__ToReactElement_Z6D3CD4B7(Common_Common_GenericOptions_Parse_9AE2F7C(options, parseOptions, "label"), (props_1, children_1) => react.createElement("label", MapUtil_keyValueList(props_1, 1, true), ...children_1), children);
}
